      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {
            recipes.map((recipe)=>(
                ...
                >
                    <div className="p-6">
                        <h2 className="text-xl font-semibold mb0-6">{recipe.title}</h2>
                        <p className="text-gray-600 mb-4">{recipe.description}</p>
                        <p className="inline-block bg-rose-100 text-rose-800 text-sm px-2 py-1 rounded">{recipe.category}</p>
                    </div>
                </Link>
            ))
        }
